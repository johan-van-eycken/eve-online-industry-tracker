...
from utils.webpage_ui import render_job_status_panel
...
NAVIGATION_PAGES = (
    ...
    PageSpec("Portfolio Planner", "webpages.portfolio_planner"),
...
ADMIN_PAGE_MODULES = {
    "Database Maintenance": "webpages.database_maintenance",
    "ESI Monitoring": "webpages.esi_monitoring",
}

ADMIN_ACTIONS = ["", "Database Maintenance", "Restart Flask App", "Restart Streamlit", "Public Structures Scan", "ESI Monitoring"]
