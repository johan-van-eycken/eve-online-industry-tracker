...
def filter_industry_characters(characters: list[dict]) -> list[dict]:
    """Return only characters with industry_enabled=True (default)."""
    return [c for c in characters if c.get("industry_enabled", True)]
