...
from eve_online_industry_tracker.infrastructure.models import CorporationModel, CorporationStructuresModel \
...
class Corporation:
    ...
    def refresh_all(self) -> None:
        ...
        try:
            ...
            # Phase 3: industry_jobs runs after wallet_transactions (needs tx data)
